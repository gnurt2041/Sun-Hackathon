...
AZURE_OPENAI_KEY = "5851fc1d0e804578933d413f593422f1"
AZURE_OPENAI_ENDPOINT = "https://sunhackathon17.openai.azure.com/"
ELASTIC_CLOUD_ID = "d382c337ef9343fdb3797e3e4b7e4650:dXMtY2VudHJhbDEuZ2NwLmNsb3VkLmVzLmlvOjQ0MyQ0MTAzOGU0NWEyODg0MmFkYjM5ZjE3ZjNlMDE4Yjk5ZiRiNjYxNDY2NjVhMmU0MDNhOTkyMjNhZDNiNDMzZTU4Mg=="
ELASTIC_API_KEY = "dzBGcUE0MEI1U3JYQUkxdUI0elY6Y2tyZHlMejhSODZiVUlmNEpkczY4UQ=="
API_VERSION = "2023-05-15"
API_EMBEDDING_DEPLOY_NAME = "ADA"
API_CHAT_DEPLOY_NAME = "GPT35TURBO16K" 
INDEX_NAME = "grammar_n3"
...
class LLM():
    ...
    def get_embeddings(self):
        self.embeddings = AzureOpenAIEmbeddings(
            azure_deployment = API_EMBEDDING_DEPLOY_NAME,
    ...
    def get_retriever(self):
        ...
        self.chatModel = AzureChatOpenAI(
            openai_api_version=API_VERSION,
            azure_deployment=API_CHAT_DEPLOY_NAME,
            temperature=0.5
        )
